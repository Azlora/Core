...
#ifndef AZLORA_QT_GUIUTIL_H
#define AZLORA_QT_GUIUTIL_H
...
/** Utility functions used by the Azlora Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "azlora:" URI into recipient object, return true on successful parsing
