...
{
    // Test regression https://github.com/azlora/azlora/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/azlora-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/azlora-core/gui/pull/568.
    // With fListen=false in ~/.config/Azlora/Azlora-Qt.conf and all else left as default,
    // azlora-qt should set both -listen and -listenonion to false and start successfully.
