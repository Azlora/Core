...
//! Entry point for AzloraApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AzloraApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AzloraGUI tests.
void AppTests::guiTests(AzloraGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AzloraGUI::consoleShown, this, &AppTests::consoleTests);
