      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->azloraAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->azloraAtStartup);
    ...
    ui->azloraAtStartup->setToolTip(ui->azloraAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->azloraAtStartup->setText(ui->azloraAtStartup->text().arg(PACKAGE_NAME));

    ui->openAzloraConfButton->setToolTip(ui->openAzloraConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AzloraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->azloraAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSAZLontrols);
...
void OptionsDialog::on_openAzloraConfButton_clicked()
{
