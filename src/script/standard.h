...
#ifndef AZLORA_SCRIPT_STANDARD_H
#define AZLORA_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a azlora address
 */
...
/**
 * Generate a Azlora scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // AZLORA_SCRIPT_STANDARD_H
