...
#ifndef AZLORA_NODE_CONNECTION_TYPES_H
#define AZLORA_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/azlora-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Azlora’s Peer-to-Peer Network")
...
#endif // AZLORA_NODE_CONNECTION_TYPES_H
