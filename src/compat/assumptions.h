...
#ifndef AZLORA_COMPAT_ASSUMPTIONS_H
#define AZLORA_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Azlora cannot be compiled without assertions."
#endif
...
#endif // AZLORA_COMPAT_ASSUMPTIONS_H
