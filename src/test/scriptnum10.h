...
#ifndef AZLORA_TEST_SCRIPTNUM10_H
#define AZLORA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Azlora Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // AZLORA_TEST_SCRIPTNUM10_H
