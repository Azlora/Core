...
{
    BOOST_CHECK(TestSplitHost("www.azloracore.org", "www.azloracore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.azloracore.org]", "www.azloracore.org", 0));
    BOOST_CHECK(TestSplitHost("www.azloracore.org:80", "www.azloracore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.azloracore.org]:80", "www.azloracore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:18654", "127.0.0.1", 18654));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:18654", "127.0.0.1", 18654));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:18654", "::ffff:127.0.0.1", 18654));
    BOOST_CHECK(TestSplitHost("[::]:18654", "::", 18654));
    BOOST_CHECK(TestSplitHost("::18654", "::18654", 0));
    BOOST_CHECK(TestSplitHost(":18654", "", 18654));
    BOOST_CHECK(TestSplitHost("[]:18654", "", 18654));
    ...
    BOOST_CHECK(TestSplitHost("www.azloracore.org:65536", "www.azloracore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.azloracore.org:0", "www.azloracore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.azloracore.org:", "www.azloracore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:18654", "127.0.0.1:18654"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:18654", "[::]:18654"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
