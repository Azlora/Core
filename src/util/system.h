 ...
 */
#ifndef AZLORA_UTIL_SYSTEM_H
#define AZLORA_UTIL_SYSTEM_H
...
extern const char * const AZLORA_CONF_FILENAME;
extern const char * const AZLORA_SETTINGS_FILENAME;
