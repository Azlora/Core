...
#ifndef AZLORA_UTIL_SYSCALL_SANDBOX_H
#define AZLORA_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during azlorad initialization if Azlora Core was compiled
...
#endif // AZLORA_UTIL_SYSCALL_SANDBOX_H
