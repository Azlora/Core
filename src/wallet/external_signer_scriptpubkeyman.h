...
#ifndef AZLORA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define AZLORA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // AZLORA_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
