...
#ifndef AZLORA_WALLET_SCRIPTPUBKEYMAN_H
#define AZLORA_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Azlora Core wallet was originally a collection of unrelated private
...
#endif // AZLORA_WALLET_SCRIPTPUBKEYMAN_H
