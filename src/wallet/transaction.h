...
#ifndef AZLORA_WALLET_TRANSACTION_H
#define AZLORA_WALLET_TRANSACTION_H
...
public:
     ...
     * on this azlora node, and set to 0 for transactions that were created
...
#endif // AZLORA_WALLET_TRANSACTION_H
