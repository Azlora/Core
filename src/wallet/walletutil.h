...
#ifndef AZLORA_WALLET_WALLETUTIL_H
#define AZLORA_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! azlora from opening the wallet, thinking it was newly created, and
...
#endif // AZLORA_WALLET_WALLETUTIL_H
