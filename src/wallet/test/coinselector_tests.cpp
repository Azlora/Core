...
BOOST_AUTO_TEST_CASE(knapsack_solver_test)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK_EQUAL(result14->GetSelectedValue(), 1 * COIN);  // we should get 1 AZL in 1 coin
        ...
        BOOST_CHECK_EQUAL(result15->GetSelectedValue(), 2 * COIN);  // we should get 2 AZL in 1 coin
...
BOOST_AUTO_TEST_CASE(check_max_weight)
{
    ...
    {
        // Scenario 1:
        // The actor starts with 1x 50.0 AZL and 1515x 0.033 AZL (~100.0 AZL total) unspent outputs
        // Then tries to spend 49.5 AZL
        // The 50.0 AZL output should be selected, because the transaction would otherwise be too large
...

    {
        ...
        // The actor starts with 400x 0.0625 AZL and 2000x 0.025 AZL (75.0 AZL total) unspent outputs
        // Then tries to spend 49.5 AZL
...

    {
        ...
        // The actor starts with 1515x 0.033 AZL (49.995 AZL total) unspent outputs
...
BOOST_AUTO_TEST_CASE(SelectCoins_effective_value_test)
{
    ...
    CoinsResult available_coins;
    {
        ...
        add_coin(available_coins, *dummyWallet, 100000); // 0.001 AZL
    }

    CAmount target{99900}; // 0.000999 AZL
