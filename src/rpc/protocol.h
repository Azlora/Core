...
#ifndef AZLORA_RPC_PROTOCOL_H
#define AZLORA_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in azlorad
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Azlora is not connected
