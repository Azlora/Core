...
#ifndef AZLORA_CRYPTO_CHACHA_POLY_AEAD_H
#define AZLORA_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@azlora.
 *
 ...
 *
 * The chacha20-poly1305@azlora combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@azlora cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@azlora are relatively fast in
...
#endif // AZLORA_CRYPTO_CHACHA_POLY_AEAD_H
