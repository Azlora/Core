...
#ifndef AZLORA_INTERFACES_NODE_H
#define AZLORA_INTERFACES_NODE_H
...
//! Top-level interface for a azlora node (azlorad process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or azlora.conf.
...
#endif // AZLORA_INTERFACES_NODE_H
