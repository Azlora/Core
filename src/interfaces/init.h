...
#ifndef AZLORA_INTERFACES_INIT_H
#define AZLORA_INTERFACES_INIT_H
...
//! (azlora-gui, azlora-node, azlora-wallet, azlorad, azlora-qt) and each
...
#endif // AZLORA_INTERFACES_INIT_H
