...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/azlora/azlora/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AzloraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our azlorad node")
