...
class NetTest(AzloraTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=18654)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 18654)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=18654), {"success": False})
