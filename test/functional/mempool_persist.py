...
By default, azlorad will dump mempool on shutdown and
...
class MempoolPersistTest(AzloraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent azlorad from writing mempool.dat to disk. Verify that `savemempool` fails")
