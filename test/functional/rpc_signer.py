...
Verify that a azlorad node can use an external signer command.
...
class RPCSignerTest(AzloraTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart azlorad with -signer=<cmd>',
