...
class TransactionTimeRescanTest(AzloraTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine AZL and create transactions
        ...
        # generate some azl to create transactions and check blockcount
        ...
        # send 10 azl to user's first watch-only address
        self.log.info('Send 10 azl to user')
        ...
        # send 5 azl to our second watch-only address
        self.log.info('Send 5 azl to user')
        ...
        # send 1 azl to our third watch-only address
        self.log.info('Send 1 azl to user')
