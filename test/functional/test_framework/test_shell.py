...
class TestShell:
    """Wrapper Class for AzloraTestFramework.

    The TestShell class extends the AzloraTestFramework
    ...
    class __TestShell(AzloraTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AzloraTestFramework child class.
            self.num_nodes = 1
