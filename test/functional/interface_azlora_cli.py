...
# The block reward of coinbaseoutput.nValue (50) AZL/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 AZL/block.
...
class TestAzloraCli(AzloraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `azlora-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and azlora-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and azlora-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (AZL/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (AZL/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 AZL) to the default wallet.
            ...
            # Test azlora-cli -generate with -rpcwallet in multiwallet mode.
