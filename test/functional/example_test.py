...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AzloraTestFramework
    pass


class ExampleTest(AzloraTestFramework):
    # Each functional test is a subclass of the AzloraTestFramework class.
    ...
    def custom_method(self):
        ...
        AzloraTestFramework class so other tests can use it."""
