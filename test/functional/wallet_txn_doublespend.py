...
class TxnMallTest(AzloraTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 AZL:
        ...
        # First: use raw transaction API to send 1240 AZL to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AZL coin each
        ...
        # Node0's balance should be starting balance, plus 50AZL for another
        ...
        # Node0's total balance should be starting balance, plus 100AZL for
