...
"""Verify that starting azlora with -h works as expected."""

from test_framework.test_framework import AzloraTestFramework
from test_framework.util import assert_equal

class HelpTest(AzloraTestFramework):
    ...
    def run_test(self):
        self.log.info("Start azlora with -h for help text")
        ...
        self.log.info("Start azlora with -version for version information")
        ...
        self.log.info("Start azlorad with -fakearg to make sure it does not start")
