Azlora version 0.5.4 is now available for download at:
http://sourceforge.net/projects/azlora/files/Azlora/azlora-0.5.4/
...
http://gitorious.org/azlora/azlorad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Azlora-Qt notifications under Growl 1.3.
Increase required age of Azlora-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAzlora properly when installing Azlora-Qt over it. (Windows)
