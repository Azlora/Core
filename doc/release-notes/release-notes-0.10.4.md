Azlora Core version 0.10.4 is now available from:

  <https://azlora.org/bin/azlora-core-0.10.4/>
...
- #6953 `43c2789` Split azlora-tx into its own package
- #6953 `dfe0d4d` Include azlora-tx binary on Debian/Ubuntu
