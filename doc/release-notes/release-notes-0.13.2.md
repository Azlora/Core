Azlora Core version 0.13.2 is now available from:

  <https://azlora.org/bin/azlora-core-0.13.2/>
...
- #8908 `4a974b2` Update azlora-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow azlora-tx to create v2 transactions (azldrak)
