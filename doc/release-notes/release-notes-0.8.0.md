Azlora-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/azlora/files/Azlora/azlora-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Azlora
...
New/changed settings (command-line or azlora.conf file)
--------------------------------------------------------
