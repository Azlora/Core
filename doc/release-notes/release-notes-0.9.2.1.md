Azlora Core version 0.9.2.1 is now available from:

  https://azlora.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AZL to 0.01 AZL
...
- Fix "Start azlora on system login"
