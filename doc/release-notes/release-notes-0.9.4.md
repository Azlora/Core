Azlora Core version 0.9.4 is now available from:

  https://azlora.org/bin/0.9.4/
...
this update is incompatible with the Azlora system and could lead to consensus
forks.

Azlora Core released binaries from https://azlora.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~azlora/+archive/ubuntu/azlora
- A third-party or self-compiled Azlora Core

upgrade to Azlora Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
