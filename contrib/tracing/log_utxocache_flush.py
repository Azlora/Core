...
"""Example logging Azlora Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/azlorad
...
def main(azlorad_path):
    ...
    b = BPF(text=program, usdt_contexts=[azlorad_with_usdts])
