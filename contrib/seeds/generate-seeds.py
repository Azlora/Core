...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef AZLORA_CHAINPARAMSSEEDS_H\n')
    g.write('#define AZLORA_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the azlora network\n')
    ...
    g.write('#endif // AZLORA_CHAINPARAMSSEEDS_H\n')
