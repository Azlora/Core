...
complete --command azlora-qt --no-files

# Extract options
function __fish_azloraqt_get_options
...
complete \
    --command azlora-qt \
    --arguments "(__fish_azloraqt_get_options --nofiles)"
