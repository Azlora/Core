...
complete --command azlorad --no-files

# Extract options
function __fish_azlorad_get_options
...
complete \
    --command azlorad \
    --arguments "(__fish_azlorad_get_options --nofiles)"
