...
# Extract options
function __fish_azlora_tx_get_options
...
# Extract commands
function __fish_azlora_tx_get_commands
...
complete \
    --command azlora-tx \
    --condition "not __fish_azlora_seen_cmd (__fish_azlora_tx_get_commands --commandsonly)" \
    --arguments "(__fish_azlora_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command azlora-tx \
    --arguments "(__fish_azlora_tx_get_commands)" \
    --no-files
