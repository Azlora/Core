...
Arguments:
    <base_directory> - The base directory of a azlora source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Azlora Core developers'
...
Arguments:
    <file> - A source file in the azlora repository.
"""
